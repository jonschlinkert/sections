...
function expected(name) {
  return fs.readFileSync('test/expected/' + name, 'utf8');
}
...
describe('sections >', function() {
  ...
  describe('format >', function() {
    ...
    describe('empty sections >', function() {
    ...
    describe('strong >', function() {
      it('should add newlines before tight headings', function() {
        var str = fixture('strong-headings.md');
        var actual = sections.format(str);
        assert.equal(actual, expected('strong-headings.md'));
      });
    });
    ...
    describe('headings >', function() {
      ...
      it('should remove extra newlines', function() {
        ...
        assert(/\n{3,}/.test(str));
        var actual = sections.format(str).trim();
        assert(!/\n{3,}/.test(actual));
      });
